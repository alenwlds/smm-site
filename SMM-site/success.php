                    ...
                    <div class="col-xs-6 smm-panel-bye">
                        <div class="panel panel-primary panel-heading2">
                            <div class="panel-body ">
                                <p style="color: black;">Ваш заказ оформлен. Для подтверждения и уточнения заказа с Вами свяжутся в ближайшее время. <a style="color: #6307af;" href="products.php">Щелкните здесь,</a> чтобы приобрести любой другой товар.</p>
                            </div>
                        </div>
                    </div>
                </div>
